package com.Guide.suchelin.Map
...
import com.Guide.suchelin.DataClass.StoreDataClassMap
import com.Guide.suchelin.R
import com.Guide.suchelin.StoreDetail.StoreDetailActivity
import com.Guide.suchelin.databinding.FragmentMapBinding
...
class MapControl {
    ...
    fun setStoreSelect(number: Int, viewpagerFlag: Boolean, naverMap: NaverMap) {
        ...
        moveMap(
            naverMap,
            LatLng(
                mSuperDataList!![markerNumber].latitude,
                mSuperDataList!![markerNumber].longitude
            )
        )
